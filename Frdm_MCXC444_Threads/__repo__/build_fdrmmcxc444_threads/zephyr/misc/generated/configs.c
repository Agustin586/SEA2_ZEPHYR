...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HAL_AFBR_MODULE_BLOBS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HAL_SILABS_MODULE_BLOBS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_NRF_WIFI_MODULE_BLOBS, 1);
